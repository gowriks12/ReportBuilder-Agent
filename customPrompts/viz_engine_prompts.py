...
instruction_str = """\
    ...
    5. The final line of code should be plt.show() Python expression that can be called with the `eval()` function to display a plot.
    6. The Plot should represent a solution to the query.
    """
